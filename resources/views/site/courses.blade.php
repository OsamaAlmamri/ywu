                    ...
                    <div class="our-courses">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="{{route('site.course_detail')}}"><img src="{{asset('site/images/resource/course-6.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="lower-content">
                                        <h5><a href="{{route('site.course_detail')}}">Interaction Design</a></h5>
                            ...
                            <div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="{{route('site.course_detail')}}"><img src="{{asset('site/images/resource/course-7.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="lower-content">
                                        <h5><a href="{{route('site.course_detail')}}">Visual Design</a></h5>
                                        <div class="text">Replenish of  third creature and meat blessed void a fruit gathered waters.</div>
                                        <div class="clearfix">
                                            <div class="pull-left">
                                                <div class="students">12 Lecturer</div>
                            ...
                            <div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="{{route('site.course_detail')}}"><img src="{{asset('site/images/resource/course-8.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="lower-content">
                                        <h5><a href="{{route('site.course_detail')}}">Wireframe Protos</a></h5>
                                        <div class="text">Replenish of  third creature and meat blessed void a fruit gathered waters.</div>
                                        <div class="clearfix">
                                            <div class="pull-left">
                                                <div class="students">12 Lecturer</div>
            ...
            <div class="row clearfix">
                ...
                <div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="{{route('site.course_detail')}}"><img src="{{asset('site/images/resource/course-15.jpg')}}" alt=""></a>
                        </div>
                        <div class="lower-content">
                            <h5><a href="{{route('site.course_detail')}}">Color Theory</a></h5>
                ...
                <div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="{{route('site.course_detail')}}"><img src="{{asset('site/images/resource/course-16.jpg')}}" alt=""></a>
                        </div>
                        <div class="lower-content">
                            <h5><a href="{{route('site.course_detail')}}">Typography</a></h5>
                            <div class="text">Replenish him third creature and meat blessed void a fruit gathered you’re, they’re two waters.</div>
                            <div class="clearfix">
                                <div class="pull-left">
                                    <div class="students">12 Lecturer</div>
                ...
                <div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="{{route('site.course_detail')}}"><img src="{{asset('site/images/resource/course-17.jpg')}}" alt=""></a>
                        </div>
                        <div class="lower-content">
                            <h5><a href="{{route('site.course_detail')}}">Wireframe & Prototyping</a></h5>
                            <div class="text">Replenish him third creature and meat blessed void a fruit gathered you’re, they’re two waters.</div>
                            <div class="clearfix">
                                <div class="pull-left">
                                    <div class="students">12 Lecturer</div>
