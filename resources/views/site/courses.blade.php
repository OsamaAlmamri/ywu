...
{{--                                <!-- Cource Block Two -->--}}
{{--                                    @foreach($subject->trainings as $training)--}}
{{--                                        <div class="cource-block-two col-lg-3 col-md-4 col-sm-6 col-xs-12 ">--}}
{{--                                            <div class="inner-box">--}}
{{--                                                <div class="image">--}}
{{--                                                    <a href="{{route('site.course_detail',$training->id)}}">--}}
{{--                                                        <img src="{{url('assets/images/resource/course-6.jpg')}}" alt=""></a>--}}
{{--                                                    <div class="divClass" style="background-image:url('{{asset("assets/images/".$training->thumbnail)}}')"></div>--}}

{{--                                                </div>--}}
{{--                                                <div class="lower-content">--}}
{{--                                                    <h5><a href="{{route('site.course_detail',$training->id)}}">{{$training->name}}</a>--}}
{{--                                                    </h5>--}}
...
{{--                                                    <div class="clearfix">--}}
{{--                                                        <div class="pull-right">--}}
{{--                                                            <div class=" students"> {{getViewCustomDate($training->start_at)}}  <i class="fa fa-calendar"></i> </div>--}}
{{--                                                        </div>--}}
{{--                                                        <div class="pull-left">--}}
...
@endsection
<script>
    import CourseComponent from "../../js/components/CourseComponent";
    export default {
