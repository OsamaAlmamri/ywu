                                ...
                                <div class="widget-content">
                                    <article class="post">
                                        <div class="post-inner">
                                            <figure class="post-thumb"><a href="blog-detail.html"><img src="{{asset('site/images/resource/post-thumb-1.jpg')}}" alt=""></a></figure>
                                    ...
                                    <article class="post">
                                        <div class="post-inner">
                                            <figure class="post-thumb"><a href="blog-detail.html"><img src="{{asset('site/images/resource/post-thumb-2.jpg')}}" alt=""></a></figure>
                                            <div class="text"><a href="blog-detail.html">Writing a Simple App</a></div>
                                            <div class="post-info">By Steve Krug</div>
                                        </div>
                                    </article>
                ...
                <div class="content-side blog-detail-column col-lg-9 col-md-12 col-sm-12">
                    <div class="blog-detail">
                        <div class="inner-box">
                            ...
                            <div class="image">
                                <img src="{{asset('site/images/resource/news-2.jpg')}}" alt="">
                            </div>
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-box">
                                <div class="comment">
                                    <div class="author-thumb"><img src="{{asset('site/images/resource/author-12.jpg')}}" alt=""></div>
                            ...
                            <div class="comment-box reply-comment">
                                <div class="comment">
                                    <div class="author-thumb"><img src="{{asset('site/images/resource/author-13.jpg')}}" alt=""></div>
                            ...
                            <div class="comment-box">
                                <div class="comment">
                                    <div class="author-thumb"><img src="{{asset('site/images/resource/author-14.jpg')}}" alt=""></div>
                        ...
                        <div class="comment-form">
                            ...
                            <form method="post" action="blog.html">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <button class="theme-btn btn-style-three" type="submit" name="submit-form"><span class="txt">Submit Your Comment <i class="fa fa-angle-left"></i></span></button>
                                    </div>
