                ...
                <div class="styled-form">
                    <form method="post" autocomplete="off" @submit.prevent="login">
                        <div class="form-group">
                            ...
                            <input type="text" v-model="form.phone" :placeholder=" $t('login.phoneOrEmail') " required="">
                        </div>
                        <div class="form-group">
                            <label> {{ $t('login.password') }} </label>
                            <span class="eye-icon flaticon-eye" @click="show_password()"></span>
                            <input :type="type_password" v-model="form.password" :placeholder="$t('login.password')"
                                   required="">
                        </div>
                        <div class="form-group">
                            <div class="clearfix">
...
<!--                                <div class="pull-right">
                        ...
                        <div class="form-group text-center">
                            <button type="button" @click="login()" class="theme-btn btn-style-three"><span class="txt"> {{ $t('MENU.login') }}  <i
