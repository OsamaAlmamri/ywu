                ...
                <div class="styled-form">
                    <form method="post" autocomplete="off" @submit.prevent="login">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" v-model="form.code" :placeholder=" $t('register.code') " required="">
                        </div>

                        <div class="form-group">
                            <label>{{ $t('profile.new_password') }}</label>
                            <input type="password" v-model="form.new_password" :placeholder=" $t('profile.new_password') " required="">
                        </div>
...
export default {
    ...
    methods: {
        login: function () {
            this.isLoading = true;
            axios({url: '/api/reset_password', data: this.form, method: 'POST'})
                .then(resp => {
